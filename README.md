...
## 📁 Repository Contents
*   [Segmentation_Logic.sql](Segmentation_Logic.sql): The backend SQL script containing the Window Functions used to segment the HCPs.
*   [Call_Plan_Dashboard.pbix](Call_Plan_Dashboard.pbix): The complete, interactive Power BI dashboard.
*   [pipeline.ipynb](pipeline.ipynb): Pandas script used for the data preprocessing and cleaning.
